//
// Mainly inspired by:
// https://github.com/openethereum/openethereum/blob/main/crates/ethcore/src/spec/spec.rs
...
pub const meowthVersion = "meowth/0.0.0-unstable";

pub const mainnetGenesisHash = common.hexToSlice("0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa3");
pub const ropstenGenesisHash = common.hexToSlice("0x41941023680923e0fe4d74a34bdac8141f2540e3ae90623718e47d66d1ca4a2d");
pub const sepoliaGenesisHash = common.hexToSlice("0x25a5cc106eea7138acab33231d7160d69cb777ee0c2c553fcddf5138993e6dd9");
pub const rinkebyGenesisHash = common.hexToSlice("0x6341fd3daf94b748c72ced5a5b26028f2474f5f00d824504e4fa37a75767e177");
pub const goerliGenesisHash = common.hexToSlice("0xbf7e331f7f7c1dd2e05159666b3bf8bc7a8a3a9eb1d518969eab529dd9b88c1a");
pub const kilnGenesisHash = common.hexToSlice("0x51c7fe41be669f69c45c33a56982cbde405313342d9e2b00d7c91a7b284dd4f8");

pub const mainnetBootnodes = [_][:0]const u8{
    ...
    // bootnode-azure-brazilsouth-001
...
pub const ropstenBootnodes = [_][:0]const u8{
    // US-Azure geth
...
pub const sepoliaBootnodes = [_][:0]const u8{
    // geth
...
pub const rinkebyBootnodes = [_][:0]const u8{
    // IE
...
pub const goerliBootnodes = [_][:0]const u8{
    // Upstream bootnodes
...
pub const kilnBootnodes = [_][:0]const u8{
...
pub const v5Bootnodes = [_][:0]const u8{
...
const mainnetChainConfig = ChainConfig{
    .chain_id = 1,
};

const ropstenChainConfig = ChainConfig{
    .chain_id = 3,
};

const sepoliaChainConfig = ChainConfig{
    .chain_id = 11155111,
};

const rinkebyChainConfig = ChainConfig{
    .chain_id = 4,
};

const goerliChainConfig = ChainConfig{
    .chain_id = 5,
};
...
pub const dnsPrefix = "enrtree://AKA3AM6LPBYEUDMVNU3BSVQJ5AD45Y7YPOHJLEF6W26QOE4VTUDPE@";

// KnownDNSNetwork returns the address of a public DNS-based node list for the given
// genesis hash and protocol. See https://github.com/ethereum/discv4-dns-lists for more
// information.
pub fn knownDNSNetwork(allocator: std.mem.Allocator, genesis: []const u8, protocol: []const u8) ![]u8 {
    var net: [:0]const u8 = undefined;
    if (std.mem.eql(u8, genesis, mainnetGenesisHash[0..])) {
        net = "mainnet";
    } else if (std.mem.eql(u8, genesis, ropstenGenesisHash[0..])) {
        net = "ropsten";
    } else if (std.mem.eql(u8, genesis, rinkebyGenesisHash[0..])) {
        net = "rinkeby";
    } else if (std.mem.eql(u8, genesis, goerliGenesisHash[0..])) {
        net = "goerli";
    } else {
        unreachable;
    }
    return try std.fmt.allocPrint(allocator, "{s}{s}.{s}.ethdisco.net", .{ dnsPrefix, protocol, net });
}
...
test "TestKnownDNSNetwork" {
    var out: []u8 = undefined;

    out = try knownDNSNetwork(testing.allocator, mainnetGenesisHash[0..], "all");
    defer testing.allocator.free(out);

    try testing.expectEqualStrings(out, "enrtree://AKA3AM6LPBYEUDMVNU3BSVQJ5AD45Y7YPOHJLEF6W26QOE4VTUDPE@all.mainnet.ethdisco.net");
}
